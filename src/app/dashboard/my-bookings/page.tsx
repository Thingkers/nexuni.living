  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-400">{bookings.length} total request{bookings.length !== 1 ? 's' : ''}</p>
      </div>
      ...
      {filtered.length === 0 ? (
        ...
        <div className="flex flex-col gap-4">
          {filtered.map((booking) => {
            ...
            return (
              <div key={booking.id} className="rounded-2xl border border-gray-100 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:p-5">
