  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-sm text-center">
        ...
        <h1 className="mb-2 text-xl font-bold text-gray-900">Verification Pending</h1>

        <p className="mb-6 text-sm text-gray-500 leading-relaxed">
          আপনার registration সফল হয়েছে। Admin আপনার Student ID card verify করার পর আপনার account activate হবে।
          সাধারণত <span className="font-medium text-gray-700">24-48 ঘণ্টা</span> সময় লাগে।
        </p>

        <div className="mb-6 rounded-xl bg-blue-50 px-4 py-3 text-xs text-blue-700 text-left">
