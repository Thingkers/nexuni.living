...
export default function ChatPage() {
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-64px)] max-w-2xl flex-col">
      ...
      {/* Header */}
      <div className="flex shrink-0 items-center gap-3 border-b border-gray-100 bg-white px-4 py-3 shadow-sm">
        <Link
          href="/inbox"
                ...
                <div key={message.id}>
                  {showDateLabel && (
                    <div className="my-4 flex justify-center">
                      <span className="rounded-full bg-gray-200/70 px-3 py-1 text-[11px] text-gray-500">
                        {dateLabel}
                      </span>
                    </div>
                  )}
      ...
      <div className="shrink-0 border-t border-gray-100 bg-white px-4 py-3">
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded-full border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm outline-none focus:border-blue-400 focus:bg-white transition-colors"
          />
          <button
            onClick={sendMessage}
